...
import {
  ...
  LogOut, Menu, UserCheck, Image, Star, MessageCircle, ShieldCheck,
} from 'lucide-react'
...
const navItems = [
  ...
  { to: '/clients', icon: ShieldCheck, label: 'مدیریت کاربران' },
  { to: '/loyalty', icon: Star, label: 'امتیاز وفاداری' },
  { to: '/chat', icon: MessageCircle, label: 'مشاوره آنلاین' },
  { to: '/settings', icon: Settings, label: 'تنظیمات سالن' },
]
